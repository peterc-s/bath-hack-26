...
PRINT "," : PRINT "KING RE'GAAN'S MOST LOYAL SERVANT WAS" : PRINT "CHILLING OUT IN THE WHITE CASTLE WHEN"
PRINT "A MESSANGER DELIVERED THEM A SCROLL..."
FOR T = 1 TO 2000 : NEXT T
PRINT "" : PRINT "'BY JOVE!' "; : PRINT PLAYERNAME$; : PRINT " EXCLAIMED."
FOR T = 1 TO 2000 : NEXT T
PRINT "" : PRINT "'THE RED DRAGON? IN THIS ECONOMY?'"
FOR T = 1 TO 2000 : NEXT T
PRINT "" : PRINT "YES, THE RED DRAGON WAS APPROACHING" : PRINT "THE IRON WALL WITH A MISSION TO"
PRINT "RADICALISE PEASANTS."
FOR T = 1 TO 2000 : NEXT T
